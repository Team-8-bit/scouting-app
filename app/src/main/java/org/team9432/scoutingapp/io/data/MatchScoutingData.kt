...
data class ChargedUpMatchScoutingData(
    ...
    val substationPreference: String = "M/A",
    val gamePiecePreference: String = "M/A",
    val defenceQuality: String = "M/A",
    val drivingQuality: String = "M/A",
    val wouldPick: String = "M/A",
    val notes: String = "",
)